...
\newfontfamily\JP{HaranoAjiGothic-Medium.otf}
...
\XF(⑨){F9}\XDS{PrtSc}(⑩){F10}%
\XDS{\AX{Pause}{\COND\textcolor{\FORECOLOR}{NumLk}}}(\char"2603){F11}%
...
\XDS{\AX{Break}{\textcolor{\FORECOLOR}{ScrLk}}}(\char"2603){F11}\XDS{Insert}(\CXA){F12}\hfill
\XD[1.8]{Delete}%
