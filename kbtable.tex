...
\XF(⑨){F9}\XDS{PrtSc}(⑩){F10}%
\XDS{\textcolor{\FORECOLOR}{\bfseries\COND NumLk}}{F11}%
\XDS{\textcolor{\FORECOLOR}{\bfseries\COND ScrLk}}{F12}\hfill
...
\XF(⑤){F5}\XF(⑥){F6}\XF(⑦){F7}\XF(⑧){F8}\hfill
\XDS{PrtSc}(⑨){F9}\XDS{\textcolor{\FORECOLOR}{\bfseries\COND NumLk}}(⑩){F10}%
\XDS{\textcolor{\FORECOLOR}{\bfseries\COND ScrLk}}{F11}\XDS{Insert}{F12}\hfill
\XD[1.8]{Delete}%
...
\K{\textcolor{cyan}{\rlap{\bfseries\normalsize AltGr}\phantom{Q}}}%
  {\rlap{\normalsize\COND Compose}\phantom{Q}}{}{}{}{}
\W2{Ctrl}
