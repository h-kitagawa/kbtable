...
\directlua{ os.execute("\luaescapestring{%
  lualatex -jobname=kbtable-blk7o %
  '\string\def\string\ROW{17}\string\def\string\BACKCOLOR{black}\string\input\space kbtable.tex' &>/dev/null
  && convert -bordercolor black -geometry 1280x800 -resize 1280 -density 300  -border 0x104 kbtable-blk7o.pdf kbd7o.png
}")}
\fi
\end{document}
