...
\advance\hsize-2\fboxrule\advance\hsize-2\fboxsep{%
  \noindent\null\Large\strut\rm\textcolor{\LINECOLOR}{\normalsize%
	#2}\hfill\null\\[\dimexpr-.5\fboxrule-\lineskip]\strut}}}%
\ignorespaces}
...
\XF[1.66]{F9}\XF[1.66]{F10}\XF[1.66]{F11}\XF[1.66]{F12}\hfill
...
\W2{Ctrl}
\smash{\raisebox{\dimexpr\baselineskip+.2pt}{\X{1.78}{\ifnum\ROW=6\small PgUp\fi}}}%
\smash{\raisebox{\dimexpr\baselineskip+.2pt}{\X{1.77}{↑}}}%
\smash{\raisebox{\dimexpr\baselineskip+.2pt}{\X{1.78}{\ifnum\ROW=6\small PgDn\fi}}}

\kern-17pt
\null
\hskip24.5\dimexpr\DX+\fboxsep+\fboxrule\relax
\X{1.78}{←}\X{1.77}{↓}\X{1.78}{→}
